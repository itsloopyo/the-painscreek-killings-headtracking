...
namespace UnityEngine {
    ...
    public struct Rect {
        ...
        public Rect(float x, float y, float width, float height) { _x = x; _y = y; _width = width; _height = height; xMin = default; xMax = default; yMin = default; yMax = default; center = default; size = default; }
